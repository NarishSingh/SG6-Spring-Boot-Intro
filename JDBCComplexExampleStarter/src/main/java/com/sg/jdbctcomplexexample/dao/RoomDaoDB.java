...
@Repository //repo for dao for rooms
public class RoomDaoDB implements RoomDao {
    ...
    public List<Room> getAllRooms() {
        ...
        return jdbc.query(SELECT_ALL_ROOMS, new RoomMapper()); //can pull back no results
    }
    ...
    @Override
    @Transactional //transaction from db, all or nothing
